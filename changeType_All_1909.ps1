...
$Action = {
    ...
    switch ($ChangeType)
    {
        ...
        'Created' { 
            ...
            $bn=$FullPath.Substring(49,3)
            $bdt=$FullPath.Substring(54,10)
            ...
            Write-Host $bn
            Copy-Item -Path $FullPath -Destination \\192.168.0.162\Soft\TestIPS\auto\Auto_Install\PY_Inst
            Start-Sleep -Seconds 5
            Set-ExecutionPolicy RemoteSigned  -Scope CurrentUse
            Import-Module VMware.VimAutomation.Core
            Set-PowerCLIConfiguration -InvalidCertificateAction Ignore -Confirm: $false
            Connect-VIServer -Server 192.168.13.138 -Protocol https -User kvn -Password 5745Ayc
            Get-Snapshot -VM kvn_1909 -Name install | Foreach-Object {
            Set-VM -VM $_.VM -Snapshot $_ -Confirm:$false}
            Wait-Event -Timeout 5
            Get-VM kvn_1909 | Stop-VM -Confirm:$false
            Wait-Event -Timeout 5
            Get-VM kvn_1909 | Start-VM -Confirm:$false
